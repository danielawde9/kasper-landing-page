      ...
      <div className="flex flex-wrap justify-center gap-8">
        {teamList.map(
          (
            ...
            <Card
              key={index}
              className="w-full sm:w-[300px] bg-muted/60 dark:bg-card flex flex-col h-full overflow-hidden group/hoverimg"
            >
              ...
              <CardFooter className="space-x-4 mt-auto flex justify-center">
